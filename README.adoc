...
Alternatively, if you are on a nix system and have `docker` installed,
...
For example:
    ...
    $ eldev emacs-docker 27.2 eldev emacs --foreground-color=red --eval '(insert (format "Emacs version: %s" emacs-version))'
